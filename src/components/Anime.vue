...
import type { CalendarDay } from '@/assets/ts/anime';
import { fetchCalendarData } from '@/assets/ts/anime';

const calendarData = reactive<CalendarDay[]>([]);
                    ...
                    <div v-for="item in day.items" :key="item.id">
                        <div class="anime">
                            <a :href="item.url" target="_blank">
                                <img :src="item.images && item.images.large ? item.images.large : 'https://dummyimage.com/350x600/cccccc/ffffff&text=%E6%97%A0%E5%B0%81%E9%9D%A2'"
                                    alt="封面图">
                            </a>

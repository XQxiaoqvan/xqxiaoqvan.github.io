...
const Config = {
  ...
  name: "xiaoqvan",
  // 头像
  avatarUrl: "https://dlink.host/sharepoint/aHR0cHM6Ly9tZW5taWFvY3ktbXkuc2hhcmVwb2ludC5jb20vOmk6L2cvcGVyc29uYWwveGlhb3F2YW5fMzY1X21lbmdhY2dfY29tL0VYV0U5TjAzS2tSS3ByRmZkd2JFVzJBQkVnaVN4ZFRyb1pLZ3c0T0RBMHdqZ0E.jpg",
  // 个人简介
  introduction: "xiaoqvan<br>欢迎来到我的个人主页",
  ...
  games: [
    { 
      ...
      playerLevel: "LV.60",
      // 角色头像
      avatar: "https://bbs-static.miyoushe.com/static/2023/11/09/4c327f3674bae7f329ad23fe7ed3230a_2210302293908001989.gif",
      // 游戏名称
      gameName: "原神",
      // 游戏图标
      gameIcon: "https://webstatic.mihoyo.com/upload/op-public/2021/10/09/def1f2abcfc2af0bbe2e5900a60a5ee1_5699547505742166353.png",
      // 游戏UID
    ...
    },
    {
      ...
      playerLevel: "LV.69",
      gameName: "崩坏：星穹铁道",
      avatar: "https://act-webstatic.mihoyo.com/darkmatter/hkrpg/prod_gf_cn/item_icon_uad6cc/7b1f88cad0daba75b83d27f09f9b336f.png",
    ...
    },
    {
      ...
      playerLevel: "LV.36",
      gameName: "绝区零",
      avatar: "https://act.mihoyo.com/app/mihoyo-zzz-game-record/images/default-avatar-cn.0ae3195d.png",
      gameIcon: "https://bbs-static.miyoushe.com/upload/op_manual_upload/fe/game_list/game_icons/1715415535005zzz-logo-v2.png",
